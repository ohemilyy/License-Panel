...
export default function App() {
            ...
            <div className="container mx-auto px-4"> 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                    ...
                    <Card>
                        <CardBody>
                            <div className="flex items-center gap-2">
                                <TiBusinessCard className="text-xl" />
                                <div>
    ...
    <CardBody className="h-60 flex flex-col justify-center">
        <p className="text-lg font-bold">Requests</p>
        <div className="chart-container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%' }}>
